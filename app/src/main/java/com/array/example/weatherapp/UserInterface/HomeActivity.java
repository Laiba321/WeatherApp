package com.array.example.weatherapp.UserInterface;
...
import com.array.example.weatherapp.CallBack.WeatherService;
import com.array.example.weatherapp.DB.WeatherDatabase;
import com.array.example.weatherapp.Utilities.Constant;
import com.array.example.weatherapp.Utilities.Utils;
import com.array.example.weatherapp.DbWeather.DatabaseHelper;
import com.array.example.weatherapp.DbWeather.Weatherdb;
import com.array.example.weatherapp.R;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener ,
    ...
    private void UserLiveData(String passwordString) {
        ...
        Call<Weatherdb> listCall = service.getWeather(gpsTracker.getLatitude(),gpsTracker.getLongitude(),
                "metric",passwordString);
        listCall.enqueue(new Callback<Weatherdb>() {
            @SuppressLint("SetTextI18n")
            @Override
            public void onResponse(Response<Weatherdb> response, Retrofit retrofit) {

                if (response.isSuccess()) {
                    Weatherdb weatherList = response.body();
    ...
    private void UseLocalData() {
        ...
        List<DatabaseHelper> dataList = mWeatherDatabase.getAllData();
        ...
        for (DatabaseHelper data : dataList) {
