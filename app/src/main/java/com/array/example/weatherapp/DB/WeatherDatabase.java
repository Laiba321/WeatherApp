package com.array.example.weatherapp.DB;
...
public class WeatherDatabase extends SQLiteOpenHelper {
    ...
    public List<DatabaseHelper> getAllData() {
        List<DatabaseHelper> contactList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                DatabaseHelper contact = new DatabaseHelper();
